...
@click.option(
    "--type", "data_types",
    type=click.Choice(["items", "feats", "enhancements", "sets", "augments"]),
    multiple=True, default=("items", "feats", "enhancements", "sets", "augments"),
...
def build_db(
    ...
    from .wiki.scraper import collect_augments, collect_enhancements, collect_feats, collect_items, collect_set_bonuses
