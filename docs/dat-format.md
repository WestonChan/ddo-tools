...
- [ ] Runearm sub-schema — **117 runearm items found with 3 runearm-specific property keys**: 0x1000076B (92%, 33/36), 0x1000278E (92%, 33/36), 0x10000C90 (67%, 33/49). These likely encode charge level, max charge, or runearm type. **Needs:** cross-reference against wiki runearm data to confirm key meanings, then wire into items parser.
