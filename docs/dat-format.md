...
- [ ] Expand STAT_DEF_IDS beyond 5 entries (sid 1692→"Well Rounded" confirmed via correlation with 6 confirmations and 0 conflicts; 5 more candidates with 1 confirmation each and 0 conflicts: 1269→"Spell Focus Mastery", 1362→"Charisma", 1524→"Constitution", 1730→"Strength", 1827→"Dodge". Most sids remain mechanism classifiers — sid 1254 appears with 172 different stats across items. String table fix (2026-03-20) enabled 1,850 matched items for correlation, up from 35.)
