...
- [ ] DDO extended VLE type tags — type tag 8193 (0x2001) found in class preambles. Understanding DDO's extensions to the Turbine VLE format would unlock class preamble decoding (hit die, BAB, saves) and potentially all Type-2 complex-partial entries. **Needs:** compare DDO VLE tags against LOTRO documentation, test higher tag values (0x2001 = type 0 + flag bits?), analyze class preamble with alternative tag interpretation.
